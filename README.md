...
- download and install [Codeblocks](http://www.codeblocks.org) and seperately [mingw](http://mingw-w64.org)
- set these mingw's execuatables in the codeblock's toolchain (settings -> compiler -> toolchain executables)
